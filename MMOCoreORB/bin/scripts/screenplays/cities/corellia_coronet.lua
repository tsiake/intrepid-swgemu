...
function CorelliaCoronetScreenPlay:spawnMobiles()
	...
	spawnMobile(self.planet, "meatlump_oaf",300,-145,30.8,-4954.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-150,30.8,-4953.5,83,0)
	spawnMobile(self.planet, "meatlump_cretin",300,-155,30.8,-4952.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-160,30.8,-4951.5,83,0)
	spawnMobile(self.planet, "meatlump_cretin",300,-165,30.8,-4948.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-170,30.8,-4938.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-175,29.8,-4944.5,83,0)
	spawnMobile(self.planet, "meatlump_clod",300,-180,30.8,-4945.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-185,30.8,-4947.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-190,30.8,-4943.5,83,0)

	spawnMobile(self.planet, "meatlump_oaf",300,-195,29.8,-4952.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-200,30.8,-4959.5,83,0)
	spawnMobile(self.planet, "meatlump_stooge",300,-205,30.8,-4944.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-210,30.8,-4949.5,83,0)
