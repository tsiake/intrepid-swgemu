...
function CorelliaCoronetScreenPlay:spawnMobiles()
	...
	spawnMobile(self.planet, "meatlump_stooge",300,-140,30.8,-4955.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-145,38.8,-4954.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-150,18.8,-4953.5,83,0)
	spawnMobile(self.planet, "meatlump_cretin",300,-155,99.8,-4952.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-160,54.8,-4951.5,83,0)
	spawnMobile(self.planet, "meatlump_cretin",300,-165,22.8,-4948.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-170,24.8,-4938.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-175,29.8,-4944.5,83,0)
	spawnMobile(self.planet, "meatlump_clod",300,-180,38.8,-4945.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-185,48.8,-4947.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-190,18.8,-4943.5,83,0)

	spawnMobile(self.planet, "meatlump_oaf",300,-195,25.8,-4952.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-200,22.8,-4959.5,83,0)
	spawnMobile(self.planet, "meatlump_stooge",300,-205,24.8,-4944.5,83,0)
	spawnMobile(self.planet, "meatlump_oaf",300,-210,21.8,-4949.5,83,0)

	spawnMobile(self.planet, "meatlump_oaf",300,-136,28.8,-4958.5,83,0)
	spawnMobile(self.planet, "meatlump_cretin",300,-72,28,-4973.1,-77,0)
	...
	spawnMobile(self.planet, "meatlump_clod",300,249.6,28,-4418.9,92,0)
